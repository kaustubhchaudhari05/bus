...
-- Dump completed on 2023-11-22 12:43:37
...
--
-- Table structure for table `booking_entity`
--
...
CREATE TABLE `booking_entity` (
  ...
  KEY `fk_bk1_idx` (`customerid`),
  KEY `fk_bk2_idx` (`startpoint`),
  KEY `fk_bk3_idx` (`endpoint`),
  CONSTRAINT `fk_bk1` FOREIGN KEY (`customerid`) REFERENCES `customer_entity` (`customerid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
--
-- Table structure for table `city_entity`
--
